...
export const archiveDetails: Record<string, ArchiveDetail> = {
  ...
  xharo: {
    ...
    blocks: [
      ...
      {
        type: "image",
        src: "/images/xharo/08-concepting-1.webp",
        width: 2500,
        height: 3265,
        alt: "Early concepting notes weighing several social-enterprise directions before settling on XHARO, alongside a definition of hxaro",
      },
      {
        type: "image",
        src: "/images/xharo/09-concepting-2.webp",
        width: 2500,
        height: 3096,
        alt: "A diagram mapping a gift's full journey between two matched users — wish list, predicted needs, or the giver's own creative vision, through acquisition, delivery, and reciprocation",
      },
      {
        type: "image",
        src: "/images/xharo/10-concepting-3.webp",
        width: 2313,
        height: 3040,
        alt: "An exposure/consideration/registration funnel diagram, a circular gift-and-reciprocation loop, a data-collection flow, and a list of open questions to resolve",
      },
      {
        type: "image",
        src: "/images/xharo/11-concepting-4.webp",
        width: 1764,
        height: 2331,
        alt: "A diagram of gift delivery between two matched users' homes, plus early wireframes for the app's sign-up, permissions, and wish-list screens",
      },
      { type: "label", text: "Storyboard" },
      {
        type: "image",
        src: "/images/xharo/12-storyboard-1.webp",
        width: 2500,
        height: 3121,
        alt: "Storyboard: a user is exposed to an XHARO ad, downloads the app, grants it permissions, and waits while it builds their profile",
      },
      {
        type: "image",
        src: "/images/xharo/13-storyboard-2.webp",
        width: 2500,
        height: 3088,
        alt: "Storyboard: the user is assigned a giving partner, chooses between a wish list or predicted needs for gift ideas, and reviews the options",
      },
      {
        type: "image",
        src: "/images/xharo/14-storyboard-3.webp",
        width: 2500,
        height: 3063,
        alt: "Storyboard: the user selects a gift, chooses a delivery method, and coordinates a meet-up over chat",
      },
      {
        type: "image",
        src: "/images/xharo/15-storyboard-4.webp",
        width: 2500,
        height: 1559,
        alt: "Storyboard: the pair meets up to exchange gifts, and XHARO follows up with both users afterward",
      },
